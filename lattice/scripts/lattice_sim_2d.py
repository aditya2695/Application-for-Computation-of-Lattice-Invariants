...
class Lattice_2d:
    ...
    def __init__(self,lattice):
        ...
        self.vol = np.linalg.det(self.mat)#volume

        print('inner prod:',self.inner)
...
class Obsuper_2d:
    ...
    def __init__(self,basis):
        ...
        self.sellings_t = [-self.p_ol, -self.p_ot, -self.p_lt] #conorms

    def red2d(self):
# reduces the basis
        fin_coform = copy.copy(self.sellings_t)
        redcount = 0
        corrcount = 0
